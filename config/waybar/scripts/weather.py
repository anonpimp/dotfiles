...
location_id='939c4e0c4d6f9ed89b8e63b7fae028fe84c1a3b58eb79c27e361fd1051c0fcd2'
...
tooltip_text = str.format(
    '{}\n{}\n{}\n{}\n{}{}',
    f'<span size="x-large" font_desc="Font Awesome 6 Pro Solid 15">{icon}</span>  <span font="14" weight="600" style="normal">{temp}C</span> ',
    f'<big>{status}</big>',
...
out_data = {
    'text': f'<span font_desc="Font Awesome 6 Pro Solid 14">{icon}</span>  <span weight="600" style="normal" font="12">{temp}C</span>',
    'alt': f'<span font_desc="Font Awesome 6 Pro Solid 14">{icon}</span>  <span weight="600" style="normal" font="12">{status}, {temp}C</span>',
